...
inputDocuments: ["docs/product-requirement.md"]
workflowType: 'prd'
classification:
  projectType: web_app
  domain: general
...
**Đối tượng:** Quán cà phê hoặc F&B phục vụ tại quầy quy mô nhỏ — một thiết bị POS (tablet landscape hoặc laptop nhỏ), một admin/chủ quán, một hoặc nhiều thu ngân.
